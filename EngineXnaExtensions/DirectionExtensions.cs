...
{
    /// <summary>Utility class for converting the simple directions to other data types.</summary>
    public static class DirectionExtensions
    {
        private static readonly float SqrtOneHalf = (float) System.Math.Sqrt(0.5);

        /// <summary>Lookup table for Vector2 conversion.</summary>
        ...
        /// <summary>Converts a simple direction to an FPoint representing that vector.</summary>
        ...
        /// <summary>Intended for use when only one axis is used (left / right or up / down).</summary>
        /// <param name="direction">the direction to convert.</param>
        /// <returns>
        ///     <c>-1</c> for left / up, <c>1</c> for right / down.
        /// </returns>
