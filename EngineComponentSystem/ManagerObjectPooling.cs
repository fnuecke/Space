...
{
    /// <summary>
    ///     This file contains the component pooling logic for the component system manager. This is used to allow quick
    ///     re-use of components without having to re-allocate memory and initialize it.
    /// </summary>
    public sealed partial class Manager
    {
        ...
        /// <summary>Releases a component for later reuse.</summary>
        ...
        /// <summary>
        ///     Releases all instances that were possibly still referenced when they were removed from the manager in running
        ///     system update loops.
        /// </summary>
        ...
        /// <summary>Allocates an entity for indexing.</summary>
        ...
        /// <summary>Releases the entity for later reuse.</summary>
