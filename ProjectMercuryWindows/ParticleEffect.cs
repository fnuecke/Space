...
namespace ProjectMercury
{
    ...
    public class ParticleEffect : EmitterCollection
    {
        ...
        /// </summary>
        public virtual void Trigger(FarPosition position, float rotation = 0.0f, float scale = 1.0f)
        {
            Trigger(position, Vector2.Zero, rotation, scale);
        }

        /// <summary>
        /// Triggers the ParticleEffect at the specified position.
        /// </summary>
        public virtual void Trigger(FarPosition position, Vector2 impulse, float rotation = 0.0f, float scale = 1.0f)
        {
        ...
        /// Triggers the ParticleEffect at the specified position.
        /// </summary>
        public virtual void Trigger(ref FarPosition position, float rotation = 0.0f, float scale = 1.0f)
        {
            var zero = Vector2.Zero;
            Trigger(ref position, ref zero, rotation, scale);
        }
