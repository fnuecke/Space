...
{
    /// <summary>
    /// Common utility implementations for readable packets.
    /// </summary>
    public static class ReadablePacketExtensions
    {
        ...
        /// <returns>This packet, for call chaining.</returns>
        public static IReadablePacket Read(this IReadablePacket packet, byte[] buffer, int offset, int count, out int length)
        {
        ...
        /// <summary>Reads an object collections.
        /// <para>
        /// May return <c>null</c>.
        /// </para></summary>
        ...
        /// <summary>Internal method used to read object collections, using the
        /// specified method to read single objects.</summary>
        ...
        {
            var numPacketizables = packet.ReadInt32();
