    ...
    public sealed class Explosion : PhysicsLogic
    {
        ...
        public Dictionary<Fixture, List<Vector2>> Activate(WorldVector2 pos, float radius, float maxForce)
        {
            ...
            for (int i = 0; i < shapeCount; ++i)
            {
                ...
                {
                    Vector2 toCentroid = (Vector2)(shapes[i].Body.GetWorldPoint(ps.MassData.Centroid) - pos);
                    ...
                    {
                        Vector2 toVertex = (Vector2)(shapes[i].Body.GetWorldPoint(ps.Vertices[j]) - pos);
            ...
            for (int i = 0; i < containedShapeCount; ++i)
            {
                ...
                Vector2 vectImp = impulse * (Vector2)(hitPoint - pos);
