...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public class PulleyJoint : Joint
    {
            ...
            : base(bodyA, bodyB)
        {
            ...
            Vector2 d1 = (Vector2)(BodyA.GetWorldPoint(localAnchorA) - groundAnchorA);
            _lengthA = d1.Length();

            Vector2 d2 = (Vector2)(BodyB.GetWorldPoint(localAnchorB) - groundAnchorB);
            _lengthB = d2.Length();
        ...
        public float LengthA
        {
            get
            {
                Vector2 d = (Vector2)(BodyA.GetWorldPoint(LocalAnchorA) - GroundAnchorA);
                return d.Length();
            }
            set { _lengthA = value; }
        }
        ...
        public float LengthB
        {
            get
            {
                Vector2 d = (Vector2)(BodyB.GetWorldPoint(LocalAnchorB) - GroundAnchorB);
                return d.Length();
            }
            set { _lengthB = value; }
        }
