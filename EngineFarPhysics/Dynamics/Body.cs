    ...
    public class Body : IDisposable
    {
        ...
        public Vector2 LocalCenter
        {
            ...
            set
            {
                ...
                Vector2 a = (Vector2)(Sweep.C - oldCenter);
        ...
        public void ApplyForce(ref Vector2 force, ref WorldVector2 point)
        {
            ...
            if (_bodyType == BodyType.Dynamic)
            {
                ...
                Force += force;
                Torque += (float)(point.X - Sweep.C.X) * force.Y - (float)(point.Y - Sweep.C.Y) * force.X;
            }
        }
        ...
        public void ApplyLinearImpulse(ref Vector2 impulse, ref WorldVector2 point)
        {
            ...
            LinearVelocityInternal += InvMass * impulse;
            AngularVelocityInternal += InvI * ((float)(point.X - Sweep.C.X) * impulse.Y - (float)(point.Y - Sweep.C.Y) * impulse.X);
        }
        ...
        public Vector2 GetLocalPoint(ref WorldVector2 worldPoint)
        {
            return
                new Vector2((float)(worldPoint.X - Xf.Position.X) * Xf.R.Col1.X + (float)(worldPoint.Y - Xf.Position.Y) * Xf.R.Col1.Y,
                            (float)(worldPoint.X - Xf.Position.X) * Xf.R.Col2.X + (float)(worldPoint.Y - Xf.Position.Y) * Xf.R.Col2.Y);
        }
