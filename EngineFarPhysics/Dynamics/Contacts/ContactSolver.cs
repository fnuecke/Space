        ...
        public void InitializeVelocityConstraints()
        {
            for (int i = 0; i < _constraintCount; ++i)
            {
                ...
                for (int j = 0; j < cc.PointCount; ++j)
                {
                    ...
                    ccp.rA = (Vector2)(points[j] - bodyA.Sweep.C);
                    ccp.rB = (Vector2)(points[j] - bodyB.Sweep.C);
        ...
        public bool SolvePositionConstraints(float baumgarte)
        {
            ...
            for (int i = 0; i < _constraintCount; ++i)
            {
                ...
                for (int j = 0; j < c.PointCount; ++j)
                {
                    ...
                    float rax = (float)(point.X - bodyA.Sweep.C.X);
                    float ray = (float)(point.Y - bodyA.Sweep.C.Y);

                    float rbx = (float)(point.X - bodyB.Sweep.C.X);
                    float rby = (float)(point.Y - bodyB.Sweep.C.Y);
                ...
                case ManifoldType.Circles:
                    {
                        ...
                        {
                            Vector2 normalTmp = (Vector2)(pointB - pointA);
