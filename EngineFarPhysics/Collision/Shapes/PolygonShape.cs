...
namespace FarseerPhysics.Collision.Shapes
{
    ...
    // This code would put the reference point inside the polygon.
                                     ...
                                     int childIndex)
        {
            ...
            Vector2 p1 = MathUtils.MultiplyT(ref transform.R, (Vector2)(input.Point1 - transform.Position));
            Vector2 p2 = MathUtils.MultiplyT(ref transform.R, (Vector2)(input.Point2 - transform.Position));
            Vector2 d = p2 - p1;
