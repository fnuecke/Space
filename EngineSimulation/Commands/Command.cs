...
namespace Engine.Simulation.Commands
{
    ...
    public abstract class Command : IEquatable<Command>, IComparable<Command>
    {
        ...
        /// <summary>
        ///     Whether the command is signed (e.g. by a server) (<c>true</c>) or came from an untrustworthy source (e.g. another
        ///     client) (<c>false</c>).
        /// </summary>
        public bool IsAuthoritative;

        /// <summary>The number of the player that issued the command.</summary>
        public int PlayerNumber = -1;

        /// <summary>The id of this command, specific to the player that created it.</summary>
        public int Id;
