...
{
    /// <summary>Base class for UDP based communication.</summary>
    public sealed class UdpProtocol : AbstractProtocol
    {
        ...
        /// <summary>The local loopback address for this protocol. Use this to send messages to from another protocol.</summary>
        ...
        /// <summary>The actual underlying UDP socket.</summary>
        ...
        /// <summary>Creates a new UDP socket listening on the given port for the given protocol.</summary>
        ...
        /// <summary>Creates a new UDP socket for sending only.</summary>
        /// <param name="protocolHeader">header of the used protocol (filter packages).</param>
        ...
        /// <summary>This is used to determine the local loopback address to use for a new instance.</summary>
        private static readonly BitArray BoundPorts = new BitArray(ushort.MaxValue);

        /// <summary>
        ///     Lookup table the instances add themselves to. This essentially fakes a tiny LAN which only exists inside the
        ///     running program.
        /// </summary>
