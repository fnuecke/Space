...
namespace FarseerPhysics
{
    ...
    internal abstract class DebugView
    {
        protected DebugView(PhysicsSystem world)
        {
            World = world;
        }

        protected PhysicsSystem World { get; private set; }
        ...
        public abstract void DrawTransform(ref WorldTransform transform);
    }
}