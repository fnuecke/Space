...
namespace Engine.Util
{
    ...
    /// <summary>Signature for command handler functions.</summary>
    /// <param name="args">
    ///     The arguments for the command (space separated strings), where the first one is the name of the
    ///     command itself.
    /// </param>
    public delegate void CommandHandler(string[] args);

    /// <summary>Signature for default command handler function.</summary>
