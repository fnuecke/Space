...
namespace Engine.ComponentSystem.Common.Components
{
    ...
    public class StaticTextureDrawable : Component, IDrawable
    {
        ...
        public StaticTextureDrawable Initialize(
            string textureName, FarPosition position, float rotation, float scale, Color tint)
        {
        ...
        /// <returns></returns>
        public StaticTextureDrawable Initialize(
            string textureName, FarPosition position, float rotation = 0, float scale = 1)
        {
        ...
        public void Draw(ContentManager content, SpriteBatch batch, FarPosition translation)
        {
