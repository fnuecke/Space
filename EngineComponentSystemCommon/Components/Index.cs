...
namespace Engine.ComponentSystem.Common.Components
{
    ...
    public sealed class Index : Component
    {
        ...
        /// <summary>
        ///     The bit mask of the index group this component will belong to. There are a total of 64 separate groups, via
        ///     the 64 bits in a ulong.
        /// </summary>
        ...
        /// <summary>The bounds used to store the indexable in indexes.</summary>
        ...
        /// <summary>Initialize with the specified index groups and the specified bounds.</summary>
        ...
        /// <summary>Initialize with the specified index groups and the specified size (width = height = size).</summary>
        /// <param name="groups">The index groups.</param>
        ...
        /// <summary>Initialize with the specified index groups.</summary>
        /// <param name="groups">The index groups.</param>
        ...
        /// <summary>Sets a new index group mask for this indexable, and emits the corresponding message, if possible.</summary>
        ...
        /// <summary>Sets new bounds for the indexable, and emits the corresponding message, if possible.</summary>
