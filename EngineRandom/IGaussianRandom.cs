...
{
    /// <summary>Interface for pseudo random number generators producing normally distributed values.</summary>
    public interface IGaussianRandom
    {
        /// <summary>Get the next sample value from a standard normal distribution.</summary>
