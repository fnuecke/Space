...
{
    /// <summary>Dictionary wrapper that supports XML serialization.</summary>
    ...
    public sealed class SerializableDictionary<TKey, TVal> : Dictionary<TKey, TVal>, IXmlSerializable, ISerializable
    {
        ...
        /// <summary>Lazy initialization of serializer used for keys mapping values stored in the dictionary.</summary>
        private XmlSerializer KeySerializer
        {
            get { return _keySerializer ?? (_keySerializer = new XmlSerializer(typeof (TKey))); }
        }

        /// <summary>Lazy initialization of serializer used for values stored in the dictionary.</summary>
        ...
        /// <summary>Serializer used for keys mapping to values stored in the dictionary.</summary>
        private XmlSerializer _keySerializer;

        /// <summary>Serializer used for values stored in the dictionary.</summary>
            ...
            : base(info, context)
        {
            ...
            for (var i = 0; i < itemCount; i++)
            {
                var pair =
                    ...
                    info.GetValue(
                        String.Format(CultureInfo.InvariantCulture, "Item{0}", i), typeof (KeyValuePair<TKey, TVal>));
        ...
        ///     structure that contains the source and destination of the serialized stream associated with the
        ...
        void ISerializable.GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            {
                info.AddValue(
                    String.Format(CultureInfo.InvariantCulture, "Item{0}", itemIndex),
                    pair,
        ...
        ///     by the <see cref="M:System.Xml.Serialization.IXmlSerializable.WriteXml(System.Xml.XmlWriter)"/>
