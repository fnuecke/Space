...
namespace Engine.IO
{
    /// <summary>Creates a layer of encryption around the specified packet stream.</summary>
    public sealed class EncryptedPacketStream : IPacketStream
    {
        ...
        /// <summary>Creates a new encryption stream around the specified packet stream.</summary>
