...
namespace Engine.ComponentSystem.Spatial.Components
{
    ...
    ///     </para>
    /// </summary>
    public sealed class Spin : Component, IAngularVelocity
    {
        #region Type ID
        ...
        /// <summary>The current rotation speed of the object.</summary>
        ...
        /// <summary>Initialize with the specified spin.</summary>
