...
namespace Engine.ComponentSystem.Spatial.Components
{
    ...
    public abstract class Collidable : Component
    {
        ...
        public override void Reset()
        {
            ...
            CollisionGroups = 0;
            ShouldSweep = false;
            PreviousPosition = WorldPoint.Zero;
            ContactList = -1;
        }
        ...
        public abstract WorldBounds ComputeBounds();
        ...
        internal abstract bool Intersects(ref Vector2 extents, ref WorldPoint position, out Vector2 normal);

        // Simple sphere intersection.
        internal abstract bool Intersects(float radius, ref WorldPoint position, out Vector2 normal);
