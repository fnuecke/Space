...
namespace Engine.FarMath
{
    ...
    ///     <para>
    ///         Use this type to store absolute positions in a very large world. It is not recommended to use this as an
    ///         alternative to normal <see cref="Vector2"/>s for performance reasons. Whenever values are relative to each
    ///         other, and therefore in a range of values that can safely be expressed with normal floats, one should convert
    ///         to <see cref="Vector2"/> and continue with that.
    ///     </para>
    /// </summary>
    /// <remarks>
    ...
    public struct FarPosition
    {
        ...
        /// <summary>Represents the origin, equivalent to a zero vector.</summary>
        public static FarPosition Zero
        {
            get { return ConstZero; }
        }

        /// <summary>Keep as private field to avoid manipulation.</summary>
        ...
        public static void Transform(FarPosition[] sourceArray, ref Matrix transform, FarPosition[] destinationArray)
        {
            ...
            {
                destinationArray[i].X = sourceArray[i].X * transform.M11 + sourceArray[i].Y * transform.M21 +
                                        transform.M41;
                destinationArray[i].Y = sourceArray[i].X * transform.M12 + sourceArray[i].Y * transform.M22 +
                                        transform.M42;
            }
        }
        ...
        /// <summary>Returns the component-wise minimum of the two specified values.</summary>
        ...
        /// <summary>Returns the inverse of the specified value (i.e. a vector in the opposite direction).</summary>
        ...
        /// <remarks>This should only be used for identity testing. Use typical floating point epsilon checks otherwise.</remarks>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="Microsoft.Xna.Framework.Vector2"/> to
        ///     <see cref="Engine.FarMath.FarPosition"/>.
        /// </summary>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="Microsoft.Xna.Framework.Point"/> to
        ///     <see cref="Engine.FarMath.FarPosition"/>.
        /// </summary>
        /// <param name="value">The value to convert.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="Engine.FarMath.FarPosition"/> to
        ///     <see cref="Microsoft.Xna.Framework.Vector2"/>.
        /// </summary>
        /// <param name="value">The value to convert.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        {
// ReSharper disable NonReadonlyFieldInGetHashCode XNA's Vector2 does the same thing.
