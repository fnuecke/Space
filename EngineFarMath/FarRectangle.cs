...
{
    /// <summary>
    ///     A "far rectangle", a rectangle based on <see cref="FarValue"/>s. It is otherwise pretty much equivalent to the
    ///     <see cref="Rectangle"/> from the XNA framework.
    /// </summary>
...
// ReSharper restore CompareOfFloatsByEqualityOperator
        ...
        /// <param name="value">The Vector2 to evaluate.</param>
        /// <param name="result">
        ///     true if the specified Vector2 is contained within this <see cref="FarRectangle"/>; false otherwise.
        /// </param>
...
// ReSharper restore CompareOfFloatsByEqualityOperator
        ...
        /// <summary>
        ///     Compares the two specified <see cref="FarRectangle"/>s for inequality.
        /// </summary>
        /// <param name="a">Source rectangle.</param>
        /// <param name="b">Source rectangle.</param>
        /// <returns>
...
// ReSharper restore CompareOfFloatsByEqualityOperator
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="Microsoft.Xna.Framework.Rectangle"/> to
        ///     <see cref="Engine.FarMath.FarRectangle"/>.
        /// </summary>
        /// <param name="rectangle">
        ///     The <see cref="Microsoft.Xna.Framework.Rectangle"/> to convert.
        /// </param>
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="Engine.FarMath.FarRectangle"/> to
        ///     <see cref="Microsoft.Xna.Framework.Rectangle"/>.
        /// </summary>
        /// <param name="rectangle">
        ///     The <see cref="Engine.FarMath.FarRectangle"/> to convert.
        /// </param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="Engine.Math.RectangleF"/> to
        ///     <see cref="Engine.FarMath.FarRectangle"/>.
        /// </summary>
        /// <param name="rectangle">
        ///     The <see cref="Engine.Math.RectangleF"/> to convert.
        /// </param>
        /// <returns>The result of the conversion.</returns>
...
// ReSharper restore CompareOfFloatsByEqualityOperator
        ...
        /// </param>
        /// <returns>
        ///     <c>true</c> if the specified value is a <see cref="FarRectangle"/> and the <see cref="FarRectangle"/>s are equal;
        ///     otherwise, <c>false</c>.
        /// </returns>
...
// ReSharper restore NonReadonlyFieldInGetHashCode
        ...
        public override string ToString()
        {
            return string.Format(
                CultureInfo.InvariantCulture, "{{X:{0} Y:{1} Width:{2} Height:{3}}}", X, Y, Width, Height);
        }
