...
{
    /// <summary>The game server, handling everything client logic related.</summary>
    internal sealed class GameClient : GameComponent
    {
        ...
        /// <summary>The interval in which we save the player's profile to disk.</summary>
        ...
        /// <summary>The controller used by this game client.</summary>
        ...
        /// <summary>Whether autoexec should run as soon as we have our avatar.</summary>
        private bool _shouldRunAutoexec;

        /// <summary>The time we last saved our profile.</summary>
        ...
        /// <summary>Creates a new local client, which will be coupled to the given server.</summary>
        ...
        /// <summary>Creates a new remote client, which can connect to remote games.</summary>
        /// <param name="game">The game to create the client for.</param>
        ...
        /// <summary>Adds event listener for connected events, to auto execute console commands.</summary>
        ...
        /// <summary>Kills off the emitter and controller.</summary>
        ...
        /// <summary>Test if this game is valid and running.</summary>
        /// <returns></returns>
        ...
        /// <summary>Get the information facade for the ship of the player with the specified number, if possible.</summary>
        /// <param name="playerNumber">The number of the player to get the info for.</param>
        ...
        /// <summary>Get the information facade for the ship of the specified player, if possible.</summary>
        ...
        /// <summary>Get the information facade for the local player's ship in the game, if possible.</summary>
        /// <returns>The local player's ship information facade.</returns>
        ...
        /// <summary>Gets the current camera position, i.e. the view center, in global coordinates.</summary>
        ...
        /// <summary>Gets the current camera zoom.</summary>
        ...
        /// <summary>Get the most current representation of a component system of the specified type.</summary>
        /// <typeparam name="T">The type of the component system to get.</typeparam>
        /// <returns>
        ///     The component system of that type, or <c>null</c>
        /// </returns>
        ...
        /// <summary>Gets the component of the specified type for the specified entity.</summary>
        ...
        /// <summary>Saves the current player state (his profile) to disk.</summary>
        public void Save()
        {
        ...
        /// <summary>We are being disconnected from the server, do a last save.</summary>
        /// <param name="sender">The sender.</param>
        /// <param name="e">
        ...
        /// <summary>We have been disconnected, cancel console autoexec if it was set.</summary>
        /// <param name="sender">The sender.</param>
        /// <param name="e">
        ///     The <see cref="System.EventArgs"/> instance containing the event data.
        /// </param>
        ...
        /// <summary>Run our autoexec file, if we have one.</summary>
