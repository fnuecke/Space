...
{
    /// <summary>Used to inject debugging commands into the simulation.</summary>
    /// <remarks>Values must be changed like this from the outside, so as not to mess up different states in a TSS simulation.</remarks>
    internal sealed class ScriptCommand : Engine.Simulation.Commands.FrameCommand
    {
        #region Fields

        /// <summary>The debug command to apply.</summary>
