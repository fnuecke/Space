...
namespace Space.Tools.DataEditor
{
    ...
    {
        private readonly ItemPoolDataDialog _dialog = new ItemPoolDataDialog();
                                         ...
                                         System.IServiceProvider provider, object value)
        {
            ...
            if ((value is string || value == null) && svc != null)
            {
                ...
                _dialog.AvailableSlots = new[] { new ItemFactory.ItemSlotInfo { Size = ItemSlotSize.None, Type = ItemFactory.ItemSlotInfo.ItemType.Fuselage } };
