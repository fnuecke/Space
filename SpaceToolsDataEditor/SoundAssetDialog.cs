...
namespace Space.Tools.DataEditor
{
    ...
    /// </summary>
    public sealed partial class SoundAssetDialog : Form
    {
        /// <summary>
        ...
        private void SoundAssetDialogLoad(object sender, EventArgs e)
        {
            tvTextures.BeginUpdate();
            tvTextures.Nodes.Clear();
            tvTextures.Nodes.Add("", "None");
            foreach (var assetName in ContentProjectManager.SoundAssetNames)
            {
        ...
        private void SoundsAfterSelect(object sender, TreeViewEventArgs e)
        {
        ...
        private void SoundsDoubleClick(object sender, EventArgs e)
        {
            if (btnOK.Enabled)
            {
                DialogResult = DialogResult.OK;
