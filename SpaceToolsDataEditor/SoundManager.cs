...
namespace Space.Tools.DataEditor
{
    internal class SoundManager
    {
        ...
        /// </summary>
        private static readonly Dictionary<string, string> AttributePools = new Dictionary<string, string>();

        private static string SavePath;
        /// <summary>
        /// Mapping AttributePools back to the files they came from, for saving.
        /// </summary>
        private static readonly Dictionary<string, string> AttributePoolFilenames = new Dictionary<string, string>();

        public delegate void AttributePoolChangedDelegate(string attributePool);
        ...
        public static void Load(string path)
        {
            ...
            Clear();
            foreach (var file in Directory.GetFiles(path, "*.xsb", SearchOption.AllDirectories))
            {
