...
{
    /// <summary>Constraints for generating attribute modifiers.</summary>
        ...
        where TAttribute : struct
    {
        ...
        /// <summary>The value range of the attribute.</summary>
        ...
        /// <summary>Whether the sampled result should be rounded to the next integer.</summary>
