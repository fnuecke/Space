...
{
    /// <summary>
    ///     A usable entity can be 'activated', triggering some response. An example would be buff scrolls or healing
    ///     potions for items.
    /// </summary>
    /// <typeparam name="TResponse">The possible responses triggered when a usable Item is activated.</typeparam>
        ...
        where TResponse : struct
    {
        ...
        /// <summary>The type of response triggered when activated.</summary>
