...
namespace JetBrains.Annotations
{
    ...
    /// <summary>
    ///     Indicates that the value of the marked type (or its derivatives) cannot be compared using '==' or '!=' operators
    ///     and <c>Equals()</c> should be used instead. However, using '==' or '!=' for comparison with <c>null</c> is always
    ///     permitted.
    /// </summary>
    /// <example>
    ///     <code>
