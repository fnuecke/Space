...
{
    /// <summary>A facade and caching class used to make it easier to query information about an item.</summary>
    public sealed class ItemInfo : Component
    {
        ...
        /// <summary>The full, localized name of the item as it may be displayed in the user interface.</summary>
        public string Name
        {
        ...
        /// <summary>The actual, localized, full name of the item to use in the GUI.</summary>
        private string _name;

        /// <summary>The name of the texture to use for rendering the item in menus and the inventory.</summary>
        ...
        /// <summary>A cached string describing the item.</summary>
        ...
        /// <summary>Determines the localized item name based on its id and effects.</summary>
        ...
        /// <summary>Puts item specific information into the given description object.</summary>
        /// <param name="description">The object to write the object information into.</param>
        public void GetDescription(ref ItemDescription description)
        {
            // Add attributes.
            description.Attributes = description.Attributes ?? new List<AttributeModifier<AttributeType>>();
            description.Attributes.Clear();
            foreach (var component in Manager.GetComponents(Entity, Attribute<AttributeType>.TypeId))
            {
                description.Attributes.Add(((Attribute<AttributeType>) component).Value);
            }
            ...
            if (weapon != null)
            {
                ...
                description.WeaponProjectileCount = weapon.Projectiles.Length;
            }
            else
            {
