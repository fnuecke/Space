...
{
    /// <summary>Tracks what items a unit may drop on death, via the item pool id to draw items from.</summary>
    public sealed class Drops : Component
    {
        ...
        /// <summary>The logical name of the item pool to draw items from when the unit dies.</summary>
