...
{
    /// <summary>
    ///     Entities with this component are part of a squad (a group of ships), which allows to keep a grouping to pick a
    ///     new lead should the old one die, as well as stuff like formation flying.
    /// </summary>
    public sealed class Squad : Component
    {
        ...
        /// <summary>Gets the squad's ID, by which it is tracked in the squad system.</summary>
        public int SquadId { get; internal set; }

        /// <summary>Gets the leader of this squad.</summary>
        public int Leader
        {
            get { return ((SquadSystem) Manager.GetSystem(SquadSystem.TypeId)).GetLeader(SquadId); }
        }

        /// <summary>Gets a list of all the members in this squad.</summary>
        public IEnumerable<int> Members
        {
            get { return ((SquadSystem) Manager.GetSystem(SquadSystem.TypeId)).GetMembers(SquadId); }
        }

        /// <summary>Gets the size of this squad, i.e. the number of members in it.</summary>
        public int Count
        {
            get { return ((SquadSystem) Manager.GetSystem(SquadSystem.TypeId)).GetCount(SquadId); }
        }

        /// <summary>Gets or sets the formation the squad keeps.</summary>
        ...
        /// <summary>
        ///     Gets or sets the formation spacing, i.e. the space to keep between individual formation slots. This should at
        ///     least be as large as the flocking separation of AI behaviors.
        /// </summary>
        ...
        /// <summary>Gets the position of this entity in the squad formation (i.e. where it should be at this time).</summary>
