...
namespace Space.ComponentSystem.Components
{
    ...
    public sealed class ColdSlowStatusEffect : AttributeStatusEffect<AttributeType>
    {
        ...
        {
            Modifiers.Add(new AttributeModifier<AttributeType>(AttributeType.MaximumVelocity,
                GameLogicConstants.ColdSlowMultiplier, AttributeComputationType.Multiplicative));
