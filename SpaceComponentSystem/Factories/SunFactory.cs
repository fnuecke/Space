...
{
    /// <summary>Generates suns based on set constraints.</summary>
    ...
    public sealed class SunFactory : IFactory
    {
        ...
        /// <summary>Radius for generated suns.</summary>
        [Category("Media")]
        ...
        /// <summary>Offset from cell center for generated suns.</summary>
        [Category("Media")]
        ...
        /// <summary>Mass of generated suns.</summary>
        [Category("Logic")]
        ...
        /// <summary>Samples the radius of this sun.</summary>
        /// <param name="random">The randomizer to use.</param>
