...
{
    /// <summary>
    /// This system can be used to render an index from the index system.
    /// </summary>
    public sealed class DebugIndexRenderSystem : AbstractSystem, IDrawingSystem, IMessagingSystem
    {
        ...
        /// <summary>
        /// Gets or sets the index group mask to render.
        /// </summary>
        ...
        /// <summary>
        /// The shape used to render index cells/entries.
        /// </summary>
