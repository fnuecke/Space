...
{
    /// <summary>This class holds some global constants that control the behavior of our physics simulation.</summary>
    internal static class Settings
    {
        ...
        /// <summary>
        ///     Number of velocity iterations to use in the solver. The suggested value by Box2D is 8. Using fewer iterations
        ...
        /// <summary>
        ///     Number of position iterations to use in the solver. The suggested value by Box2D is 3. Using fewer iterations
        ///     increases performance but accuracy suffers. Likewise, using more iterations decreases performance but improves the
        ///     quality of your simulation.
        /// </summary>
        ...
        /// <summary>
        ///     Number of position iterations to use in the TOI solver. The hardcoded value by Box2D is 20. Using fewer
        ///     iterations increases performance but accuracy suffers. Likewise, using more iterations decreases performance but
        ///     improves the quality of your simulation.
        /// </summary>
        ...
        /// <summary>
        ///     The maximum number of vertices on a convex polygon. You cannot increase this too much because b2BlockAllocator
        ///     has a maximum object size.
        /// </summary>
        ...
        /// </summary>
        public const float Baumgarte = 0.2f, BaumgarteTOI = 0.75f;
