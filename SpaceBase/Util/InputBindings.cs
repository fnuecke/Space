...
{
    /// <summary>
    /// This class keeps track of command bindings across multiple input devices,
    /// including mice, keyboards and gamepads.
    /// </summary>
        ...
        where TCommand : struct
    {
        ...
        /// <summary>
        /// Command to input binding mapping.
        /// </summary>
        private readonly Dictionary<TCommand, Bindings> _bindings = new Dictionary<TCommand, Bindings>();

        /// <summary>
        /// Mouse button to command mapping.
        /// </summary>
        private readonly Dictionary<MouseButtons, TCommand> _mouseButtonBindings = new Dictionary<MouseButtons, TCommand>();

        /// <summary>
        /// Mouse wheel to command mapping.
        /// </summary>
        private readonly Dictionary<MouseWheel, TCommand> _mouseWheelBindings = new Dictionary<MouseWheel, TCommand>();

        /// <summary>
        /// Keyboard key to command mapping.
        /// </summary>
        private readonly Dictionary<Keys, TCommand> _keyboardBindings = new Dictionary<Keys, TCommand>();

        /// <summary>
        /// GamePad button to command mapping.
        /// </summary>
        private readonly Dictionary<Buttons, TCommand> _gamePadButtonBindings = new Dictionary<Buttons, TCommand>();

        /// <summary>
        /// GamePad axis to command mapping.
        /// </summary>
        private readonly Dictionary<ExtendedAxes, TCommand> _gamePadAxisBindings = new Dictionary<ExtendedAxes, TCommand>();
        ...
        /// <summary>
        /// Add a new mouse button binding.
        /// </summary>
        ...
        /// <summary>
        /// Add a new gamepad button binding.
        /// </summary>
        /// <param name="command">The command that should be triggered.</param>
        ...
        /// <summary>
        /// Add a new gamepad axis binding.
        /// </summary>
        /// <param name="command">The command that should be triggered.</param>
        ...
        /// <summary>
        /// Get the command assigned to the specified mouse button.
        /// </summary>
        ...
        /// <summary>
        /// Get the command assigned to the specified mouse wheel direction.
        /// </summary>
        ...
        /// <summary>
        /// Get the command assigned to the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Get the command assigned to the specified gamepad axis.
        /// </summary>
        ...
        /// <summary>
        /// Get the command assigned to the specified gamepad button.
        /// </summary>
        /// <param name="button">The button to test.</param>
        /// <returns>The command, or the default value if there is no such binding.</returns>
        ...
        /// <summary>
        /// Test if a specific command is currently active.
        /// </summary>
        ...
        public bool Test(TCommand command, Func<Keys, bool> testCallback)
        {
            ...
            foreach (var key in bindings.KeyboardKeys)
            {
                if (testCallback(key))
                {
                    return true;
            ...
            // Nothing triggered, so this command is not active.
            return false;
        }

        /// <summary>
        /// Get the maximum value of any axis that is mapped to the specified
        /// command.
        /// </summary>
        /// <param name="command">The command to test for.</param>
        ...
        void IXmlSerializable.WriteXml(XmlWriter writer)
        {
            foreach (var kvp in _bindings)
            {
                ...
                writer.WriteAttributeString("Command", kvp.Key.ToString());

                // Write all bindings as child elements.
                foreach (var button in kvp.Value.MouseButtons)
                {
                    writer.WriteElementString("Mouse", button.ToString());
                }
                foreach (var wheel in kvp.Value.MouseWheel)
                {
                    writer.WriteElementString("Wheel", wheel.ToString());
                }
                foreach (var key in kvp.Value.KeyboardKeys)
                {
                    writer.WriteElementString("Key", key.ToString());
                }
                foreach (var button in kvp.Value.GamePadButtons)
                {
                    writer.WriteElementString("GamePad", button.ToString());
                }
                foreach (var axis in kvp.Value.GamePadAxes)
                {
        ...
        /// <summary>
        /// Utility method for getting bindings for a specific command.
        /// </summary>
        ...
        /// <summary>
        /// Utility class for mapping commands to bindings. Easier to read than
        /// when using a Tuple.
        /// </summary>
