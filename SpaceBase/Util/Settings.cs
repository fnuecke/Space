...
{
    /// <summary>
    ///     All the game settings that can be changed and saved. Also provides utility methods for saving to and loading
    ///     from XML files.
    /// </summary>
    public sealed class Settings
    {
        ...
        /// <summary>The horizontal display resolution to use.</summary>
        ...
        /// <summary>Run full screen mode or not.</summary>
        ...
        /// <summary>Which bloom filter to use.</summary>
        public string Bloom = "None";

        /// <summary>The scaling of the GUI.</summary>
        [ScriptAccess("GuiScale", MinValue = 0.25, MaxValue = 2.0)]
        public float GuiScale = 1.0f;

        /// <summary>
        ///     Compute the distance displayed in radar icons as the distance of the object to the screen edge instead of to
        ///     the player ship.
        /// </summary>
        ...
        /// <summary>The locale to use for localized content.</summary>
        ...
        /// <summary>The name of the profile currently in use.</summary>
        [ScriptAccess("Profile")]
        public string CurrentProfileName = string.Empty;

        /// <summary>The actual profile currently in use.</summary>
        [XmlIgnore]
        ...
        /// <summary>Relative or absolute path to the folder to store profiles in.</summary>
        public string ProfileFolder = "save";

        /// <summary>Address of the last server we tried to connect to.</summary>
        public string LastServerAddress = "127.0.0.1";

        /// <summary>Autoexec file, contains console commands to automatically execute after joining a game.</summary>
        ...
        /// <summary>Input bindings for game control as set by the player.</summary>
        [ScriptAccess("GameBindings")]
        public InputBindings<GameCommand> GameBindings = new InputBindings<GameCommand>();

        /// <summary>Input bindings for gamepad axis control as set by the player.</summary>
        [ScriptAccess("AxisBindings")]
        public InputBindings<GamePadCommand> AxisBindings = new InputBindings<GamePadCommand>();

        /// <summary>Whether to toggle stabilizer functionality or keep it active only while the key is pressed.</summary>
        [ScriptAccess("StabilizeToggles")]
        public bool StabilizeToggles = true;

        /// <summary>Whether to toggle shield functionality or keep it active only while the key is pressed.</summary>
        [ScriptAccess("ShieldToggles")]
        public bool ShieldToggles;

        /// <summary>Whether to use a game pad, if attached, for input.</summary>
        [ScriptAccess("UseGamepad")]
        public bool EnableGamepad = false;

        /// <summary>
        ///     Epsilon value below which to ignore axis values (to compensate for construction based inaccuracies in game
        ///     pads).
        /// </summary>
        public float GamePadDetectionEpsilon = 0.15f;

        /// <summary>Invert the horizontal acceleration axis.</summary>
        public bool InvertGamepadAccelerationAxisX;

        /// <summary>Invert the vertical acceleration axis.</summary>
        public bool InvertGamepadAccelerationAxisY = true;

        /// <summary>Invert the horizontal look axis.</summary>
        public bool InvertGamepadLookAxisX;

        /// <summary>Invert the vertical look axis.</summary>
        public bool InvertGamepadLookAxisY = true;

        #region Update Methods

        /// <summary>Restores the default input bindings for ingame commands.</summary>
        ...
        /// <summary>Restores the default input bindings for gamepad axii.</summary>
        ...
        /// <summary>Save all current values to a file with the given name.</summary>
            ...
            try
            {
                ...
                using (
                    var writer = XmlWriter.Create(
                        File.Create(filename), new XmlWriterSettings {OmitXmlDeclaration = true, Indent = true}))
                {
                    // And strip away namespaces, we don't want those.
                    new XmlSerializer(typeof (Settings)).Serialize(
                        writer,
                        _instance,
                        new XmlSerializerNamespaces(new XmlSerializerNamespaces(new[] {new XmlQualifiedName("", "")})));
                }
            }
        ...
        /// <summary>
        ///     Load settings from a file. This will invalidate any old references to <c>Settings.Instance</c>. It will also
        ///     overwrite <em>all</em> settings, not just the ones loaded from the file. For all fields not set, the default values
        ///     will be restored.
        /// </summary>
        ...
        /// <summary>The singleton instance of the settings class.</summary>
        public static Settings Instance
        {
            get { return _instance ?? (_instance = new Settings()); }
        }

        /// <summary>The actual current instance.</summary>
        private static Settings _instance;

        /// <summary>Singleton enforcement.</summary>
        private Settings()
        {
