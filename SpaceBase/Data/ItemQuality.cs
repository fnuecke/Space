...
{
    /// <summary>List of possible item quality levels.</summary>
    public enum ItemQuality
    {
        ...
        /// <summary>Common quality.</summary>
        Common,

        /// <summary>Uncommon quality.</summary>
        Uncommon,

        /// <summary>Rare quality.</summary>
        Rare,

        /// <summary>Epic quality.</summary>
        Epic,

        /// <summary>Legendary quality.</summary>
        Legendary,

        /// <summary>Unique quality.</summary>
        Unique
    }

    /// <summary>Utility methods for item quality levels.</summary>
    public static class ItemQualityExtensions
    {
        ...
        /// <summary>Get the display color for the specified item quality.</summary>
