...
{
    /// <summary>Utility class for rendering planets.</summary>
    public sealed class Planet : AbstractShape
    {
        #region Properties

        /// <summary>The surface texture.</summary>
        ...
        /// <summary>Gets or sets the surface normals texture.</summary>
        ...
        /// <summary>Gets or sets the surface specular texture.</summary>
        ...
        /// <summary>Gets or sets the surface lights texture.</summary>
        ...
        /// <summary>Gets or sets the cloud texture.</summary>
        ...
        /// <summary>The surface tint applied to the surface texture.</summary>
        ...
        /// <summary>Gets or sets the alpha (intensity) of the specular highlight.</summary>
        ...
        /// <summary>Gets or sets the exponent used in specular lighting (higher values mean smaller, brighter area).</summary>
        ...
        /// <summary>Gets or sets the offset used in specular lighting (higher values mean closer to planet center).</summary>
        ...
        /// <summary>The atmosphere tint applied to the planet's atmosphere.</summary>
        ...
        /// <summary>The rotational speed of the planet's surface along the x-axis.</summary>
        ...
        /// <summary>The direction the light is coming from (vector to the sun this planet is orbiting).</summary>
        ...
        /// <summary>The current game time, which is used to determine the current rotation of the planet, in seconds.</summary>
        public float Time
        {
            get { return _time; }
            set { _time = value; }
        ...
        /// <summary>The texture used for rendering the planet surface.</summary>
        private Texture2D _surface;

        /// <summary>The surface normals texture.</summary>
        private Texture2D _normals;

        /// <summary>The surface specular texture.</summary>
        private Texture2D _specular;

        /// <summary>The surface lights texture.</summary>
        private Texture2D _lights;

        /// <summary>The clouds texture.</summary>
        private Texture2D _clouds;

        /// <summary>The specular alpha (intensity).</summary>
        private float _specularAlpha = 1;

        /// <summary>The specular exponent.</summary>
        private float _specularExponent = 10;

        /// <summary>The specular offset (light height).</summary>
        private float _specularOffset = 1;

        /// <summary>The tint used for the atmosphere.</summary>
        ...
        /// <summary>The direction the light's coming from (sun the planet orbits).</summary>
        private Vector2 _lightDirection;

        /// <summary>Rotation speed of the base image along the x-axis.</summary>
